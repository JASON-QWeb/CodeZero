...
const humanWaitingStatuses = new Set<TaskStatus>(["PRD_REVIEW_REQUIRED", "HUMAN_REVIEW", "WAITING_MERGE"]);
...
const transitions: Record<TaskStatus, TaskStatus[]> = {
  ...
  PR_CREATING: ["WAITING_MERGE", "HUMAN_REVIEW", "FAILED", "CANCELLED"],
  HUMAN_REVIEW: ["DONE", "IMPLEMENTING", "WAITING_MERGE", "BLOCKED", "CANCELLED"],
  WAITING_MERGE: ["DONE", "IMPLEMENTING", "BLOCKED", "CANCELLED"],
  DONE: [],
  BLOCKED: ["DONE", "IMPLEMENTING", "PRD_REVIEW_REQUIRED", "CANCELLED"],
